<template>
  <q-tabs align="justify" :inline-label="!mobileMode" :dense="mobileMode" narrow-indicator>
    ...
    <q-route-tab to="/" :label="mobileMode ? '' : 'Inicio'" icon="pets" />
    <q-route-tab to="/about" :label="mobileMode ? '' : 'Acerca'" icon="info" />
    <q-route-tab to="/contact" :label="mobileMode ? '' : 'Contacto'" icon="chat" />
  </q-tabs>
</template>
